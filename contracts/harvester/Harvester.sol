...
// // import './interfaces/IBoostCounter.sol';
...
//
//     // user => tokenIds
//     mapping (address => EnumerableSet.UintSet) private legionStaked;
//     // user => tokenId => amount
...
//         _recalculateLpAmount(msg.sender);
//
//         IERC1155(treasure).safeTransferFrom(address(this), msg.sender, _tokenId, _amount, bytes(""));
//
...
//         _recalculateLpAmount(msg.sender);
//
//         IERC721(legion).transferFrom(msg.sender, address(this), _tokenId);
//
...
//         _recalculateLpAmount(msg.sender);
//
//         IERC721(legion).transferFrom(address(this), msg.sender, _tokenId);
//
